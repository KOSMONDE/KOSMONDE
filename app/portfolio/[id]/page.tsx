...
import { ExternalLink, ArrowLeft, User, Clock, Calendar, CheckCircle, Star, Zap } from "lucide-react"
      ...
      <main className="pt-20">
        <section className="relative overflow-hidden bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 py-20">
          ...
          <div className="absolute inset-0 opacity-30">
            ...
            <div className="absolute top-3/4 left-1/2 w-1.5 h-1.5 bg-rose-400 rounded-full animate-pulse delay-300"></div>
          </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div className="relative max-w-5xl mx-auto">
              <div className="relative p-1 bg-gradient-to-r from-purple-500 via-pink-500 to-cyan-500 rounded-2xl">
                <img
                  src={project.image || "/placeholder.svg?height=600&width=1200&query=modern web application mockup"}
                  alt={project.title}
                  ...
                  <div>
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                      {project.images.slice(1).map((image, index) => (
                        ...
                        >
                          <img
                            src={image || `/placeholder.svg?height=300&width=500&query=project screenshot ${index + 1}`}
