  ...
  const projects = [
    {
      id: 1,
      title: "SEKOBA",
      description: "Salon de coiffure haut de gamme avec design raffiné et réservation en ligne simple et intuitive",
      image: "/banner_image.webp",
    ...
    },
    {
      id: 2,
      title: "GBM-AVOCATS",
      description: "Cabinet d’avocats associés avec site professionnel, clair, moderne et axé sur la prise de contact",
      image: "/GBM.jpg?height=300&width=400",
