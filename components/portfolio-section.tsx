...
export default function PortfolioSection() {
  // 👉 On affiche uniquement les 3 premiers projets
    ...
    const observer = new IntersectionObserver(
      (entries) => {
        entries.forEach((entry) => {
          ...
          // ✅ Cast propre + typage des éléments trouvés
  ...
  return (
    <section
      ref={sectionRef}
      id="portfolio"
      className="py-20 px-4 sm:px-6 lg:px-8 cosmic-bg"
    >
