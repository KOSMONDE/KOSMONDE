  ...
  const steps = [
    {
      ...
      text: "Nous posons objectifs, pages clés et priorités SEO locales.",
    },
    {
      step: "02",
      title: "Design & structure",
      subtitle: "Prototype validé",
      text: "Maquettes, wording et plan de pages testés et ajustés ensemble.",
    },
    {
      step: "03",
      ...
      <div className="container-kosmonde space-y-12 py-16 relative">
        ...
        <div className="text-center max-w-2xl mx-auto space-y-3">
          <span className="inline-flex w-fit items-center justify-center rounded-full border border-sky-500/40 bg-sky-500/10 pl-4 pr-3 py-1 text-[10px] font-medium uppercase tracking-[0.25em] text-sky-200/90 shadow-[0_0_0_1px_rgba(8,47,73,0.45)] sm:text-[11px]">
            ...
            Process client clair
          </span>
          <h2 className="text-xl sm:text-3xl font-semibold tracking-tight text-slate-50">
        ...
        <div className="relative max-w-5xl mx-auto">
          ...
          <ol className="grid gap-6 md:gap-5 md:grid-cols-3">
            {steps.map((item) => (
              <li
                key={item.step}
                className="
                  relative flex h-full flex-col rounded-2xl border border-slate-800/60 bg-slate-950/85
                  px-6 py-6 sm:py-8
              ...
              >
                ...
                <div className="mb-4 flex items-center gap-3">
                  <span className="relative flex h-10 w-10 items-center justify-center rounded-full border border-sky-400/60 bg-slate-950 text-[10px] font-semibold tracking-[0.25em] text-sky-200 shadow-[0_10px_30px_rgba(14,165,233,0.25)]">
                    {item.step}
                  </span>
